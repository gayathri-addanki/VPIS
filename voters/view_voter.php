...
<div class="container-fluid">
    <div class="text-center">
			<img src="<?= validate_image(isset($image_path) ? $image_path : '') ?>" alt="" id="cimg" class="img-thumbnail rounded-circle">
    </div>
    <fieldset>
        <legend>Precinct No./Code</legend>
        <h4 class="pl-4"><b><?= isset($precinct_code) ? $precinct_code : "N/A" ?></b></h4>
    </fieldset>
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <dl><dt class="text-muted">Name</dt>
