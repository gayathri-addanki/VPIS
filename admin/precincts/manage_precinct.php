...
<div class="container-fluid">
	<form action="" id="precinct-form">
		<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
		<div class="form-group">
			<label for="code" class="control-label">Precinct No./Code</label>
...
<script>
	$(document).ready(function(){
		$('#precinct-form').submit(function(e){
			e.preventDefault();
            var _this = $(this)
			 $('.err-msg').remove();
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_precinct",
